...
## AI Use
### Scope of Assistance 
* **Syntax & Concept Review:** Used Gemini (3.6 Flash) and Claude (Opus 4.8) to review Python dictionary methods and syntax for nested data structures. (‘CSC370_A_Star.py’, line 1)
